...
package com.mycalendar.view.wheel.widget;
...
import com.mycalendar.view.wheel.widget.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	// The number of first item in goods_type
	 ...
	 * Actual amount of visible items depends on wheel goods_type parameters.
	...
	/**
	 * Calculates desired height for goods_type
	 * 
	 * @param layout
	 *            the source goods_type
	 * @return the desired goods_type height
	 */
	 ...
	 * @param widthSize the input goods_type width
	 * @param mode the goods_type mode
	 ...
	 * @param width the goods_type width
	 * @param height the goods_type height
	 */
	...
	/**
	 * Adds view for item to items goods_type
	 * @param index the item index
