...
public class WheelRecycle {
	...
	/**
	 * Recycles items from specified goods_type.
	 * There are saved only items not included to specified range.
	 * All the cached items are removed from original goods_type.
	 * 
	 * @param layout the goods_type containing items to be cached
	 * @param firstItem the number of first item in goods_type
